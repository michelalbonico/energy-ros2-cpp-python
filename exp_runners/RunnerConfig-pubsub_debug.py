...
class RunnerConfig:
    ...
    name:                       str             = "cpp_py_ros2_pub_sub_debug"
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        interval = FactorModel("msg_interval", [0.05, 0.1]) # JoyStick, then doubling until a good rate for logging that do not stress the system
        num_clients = FactorModel("num_clients", [1, 2, 3])
        language = FactorModel("language", ['py', 'cpp'])
        exec_time = FactorModel("exec_time", [90])
