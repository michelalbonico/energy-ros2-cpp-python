...
class RunnerConfig:
    ...
    name:                       str             = "cpp_py_ros2_pub_sub_0_1"
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        interval = FactorModel("msg_interval", [0.1]) # JoyStick, then doubling until a good rate for logging that do not stress the system
